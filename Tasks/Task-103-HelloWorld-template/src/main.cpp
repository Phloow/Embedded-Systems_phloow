...
Notes:          //?For PlatformIO, the repo clone is symlinked as a dependency in platformio.ini (see mindmap for details) for any project that needs the library.
                ...
                //?For a precompiled project, if you simply want to upload to your Nucleo board, open the C:\Users\USER\myGit\Embedded-Systems_phloow\Tasks\Task-103-HelloWorld-template\.pio\build\nucleo_f429zi\firmware.bin
*********/
